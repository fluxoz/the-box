//! The wordlist behind memorable generated credentials.
//!
//! A person has to be able to read a generated password off the screen, type it
//! into another device, and stand a chance of remembering it. Random hex fails
//! all three. These are the EFF "short" words: three to five letters, chosen to
//! be common, unambiguous when spoken, and quick to type, with no pairs that
//! differ only by a confusable character.
//!
//! Source: Electronic Frontier Foundation, "EFF's Short Wordlist #1"
//! (<https://www.eff.org/dice>), used under CC BY 3.0 US. Embedded rather than
//! fetched: the console must work on a Box with no Internet. Hyphenated entries
//! are dropped because '-' is the separator.
//!
//! 1295 words is 10.34 bits each, so the five-word default carries
//! 51.7 bits before the digits are added.

pub static WORDS: [&str; 1295] = [
    ...
    "yelp", "yield", "yodel", "yoga", "yoyo", "yummy", "zebra", "zero", "zesty", "zippy", "zone",
    "zoom",
];
