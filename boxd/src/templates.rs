...
impl Template for StaticSite {
    ...
    fn nix_module(&self, name: &str, params: &Value) -> String {
        // Names are validated to [a-z0-9-], safe to splice. Content lives in
        // the generation tree; this module records intent for the OS tier.
        let domain = params
            .get("domain")
            .and_then(Value::as_str)
            .map(|d| format!("\n    domain = \"{d}\";"))
